...
class _NotificationScreenState extends State<NotificationScreen> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          padding: EdgeInsets.symmetric(horizontal: 20), // Updated padding
        ),
      ),
      body: Center(
        child: notifications.isEmpty
            ? buildIllustration() // Display illustration if there are no notifications
            : buildNotificationList(), // Display notification list if there are notifications
      ),
    );
  }
 ...
 /* void addNewNotification(String message) {
    setState(() {
      ...
      final DateFormat formatter = DateFormat('yyyy-MM-dd at hh:mm a'); // Use DateFormat for date formatting
