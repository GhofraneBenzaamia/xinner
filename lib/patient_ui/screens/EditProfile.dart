...
import 'package:xinner/patient_ui/screens/besoin.dart';
...
EdgeInsets padding = EdgeInsets.only(
  ...
  right: screenWidth * 0.046,); // 15/326 pour la largeur de l'écran

  
    return Scaffold(
      appBar: AppBar(
        title:  Text('      Edit Profile Page', style: TextStyle( fontWeight: FontWeight.bold),),
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: IconButton(
                              ...
                              icon: Center(child: Icon(Icons.edit,color: Colors.white,)),)
  ...
  Widget buildTextField(String labelText, String placeholder, bool isPasswordTextField) {
    return Padding(
      ...
      child: TextField(obscureText: isPasswordTextField ? true : false,
