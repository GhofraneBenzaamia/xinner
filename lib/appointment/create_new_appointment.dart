...
class CreateNewAppointment extends StatefulWidget {
  ...
  const CreateNewAppointment({super.key});

  @override
  State<CreateNewAppointment> createState() => _CreateNewAppointmentState();
}
              ...
              MyButton(
                  ...
                  onPressed: () async {
                    if (formstate.currentState!.validate()) {
                      ...
                      String fileName = await uploadFileForUser(selectedFile);
                      if (selectedFile == null) {
                        snackBar(
                            title: "Error",
                            message: "Please upload your medical prescription",
                            isError: true);
                        return;
                      }
